...
* CSS properties should be used instead of DOM properties (margin-left vs. marginLeft)
* The Ajax requests should really return data instead of the request object if possible (json/etc)
* Make turing tests able to work with asynchronous tests (i.e., Ajax)
