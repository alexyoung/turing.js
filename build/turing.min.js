(function(_1){
var _2={VERSION:"0.0.11",lesson:"Part 11: Events",alias:"$t"};
...
turing.oo={create:function(){
var _8=null,_9=undefined,_a=function(){
this.$super=function(_b,_c){
return turing.oo.$super(this.$parent,this,_b,_c);
};
...
turing.oo.extend(_a.prototype,_9.prototype);
_a.prototype.$parent=_9.prototype;
}
turing.oo.mixin(_a,_8);
turing.oo.extend(_a.prototype,_8);
...
turing.oo.extend(_d.prototype,_e.include.prototype);
}else{
for(var i=0;i<_e.include.length;i++){
turing.oo.extend(_d.prototype,_e.include[i].prototype);
}
}
}
...
turing.enumerable={Break:{},each:function(_16,_17,_18){
try{
if(Array.prototype.forEach&&_16.forEach===Array.prototype.forEach){
_16.forEach(_17,_18);
}else{
if(turing.isNumber(_16.length)){
...
var _1c=[];
turing.enumerable.each(_19,function(_1d,_1e,_1f){
...
var _23=[],_24=!turing.isArray(_20);
turing.enumerable.each(_20,function(_25,_26,_27){
...
},detect:function(_2b,_2c,_2d){
var _2e;
turing.enumerable.each(_2b,function(_2f,_30,_31){
if(_2c.call(_2d,_2f,_30,_31)){
_2e=_2f;
throw turing.enumerable.Break;
}
});
return _2e;
},reduce:function(_32,_33,_34,_35){
if(Array.prototype.reduce&&_32.reduce===Array.prototype.reduce){
return _32.reduce(turing.bind(_34,_35),_33);
}
turing.enumerable.each(_32,function(_36,_37,_38){
_33=_34.call(_35,_33,_36,_37,_38);
});
return _33;
},flatten:function(_39){
return turing.enumerable.reduce(_39,[],function(_3a,_3b){
if(turing.isArray(_3b)){
return _3a.concat(turing.enumerable.flatten(_3b));
}
_3a.push(_3b);
return _3a;
});
},tail:function(_3c,_3d){
_3d=typeof _3d==="undefined"?1:_3d;
return Array.prototype.slice.apply(_3c,[_3d]);
},invoke:function(_3e,_3f){
var _40=turing.enumerable.tail(arguments,2);
return turing.enumerable.map(_3e,function(_41){
return (_3f?_41[_3f]:_41).apply(_41,_40);
});
},pluck:function(_42,key){
return turing.enumerable.map(_42,function(_43){
return _43[key];
});
},some:function(_44,_45,_46){
_45=_45||turing.enumerable.identity;
if(Array.prototype.some&&_44.some===Array.prototype.some){
return _44.some(_45,_46);
}
var _47=false;
turing.enumerable.each(_44,function(_48,_49,_4a){
if(_47=_45.call(_46,_48,_49,_4a)){
throw turing.enumerable.Break;
}
});
return _47;
},all:function(_4b,_4c,_4d){
_4c=_4c||turing.enumerable.identity;
if(Array.prototype.every&&_4b.every===Array.prototype.every){
return _4b.every(_4c,_4d);
}
var _4e=true;
turing.enumerable.each(_4b,function(_4f,_50,_51){
if(!(_4e=_4e&&_4c.call(_4d,_4f,_50,_51))){
throw turing.enumerable.Break;
}
});
return _4e;
},include:function(_52,_53){
if(Array.prototype.indexOf&&_52.indexOf===Array.prototype.indexOf){
return _52.indexOf(_53)!=-1;
}
var _54=false;
turing.enumerable.each(_52,function(_55,key){
if(_54=_55===_53){
throw turing.enumerable.Break;
}
});
...
return new turing.enumerable.Chainer(_56);
},identity:function(_57){
return _57;
}};
...
turing.chainableMethods=["map","collect","detect","filter","reduce","tail","rest","reject","pluck","any","some"];
turing.enumerable.Chainer=turing.Class({initialize:function(_58){
this.results=_58;
},values:function(){
return this.results;
}});
turing.enumerable.each(turing.chainableMethods,function(_59){
var _5a=turing.enumerable[_59];
turing.enumerable.Chainer.prototype[_59]=function(){
...
turing.functional={curry:turing.bind,memoize:function(_5c,fn){
var _5d=function(n){
var _5e=_5c[n];
...
turing.enumerable.each(turing.enumerable,function(fn,_db){
_da[_db]=fn;
});
}
if(turing.dom){
